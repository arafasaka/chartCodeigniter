...
<div class="login-form">
	<h2 class="text-center">Covid 19 - Self Assessment RT10/39</h2>
    <form action="<?php echo $action ?>" method="post">
		<div class="avatar">
			<img src="assets/images/visit.png" alt="Avatar">
		</div>           
		...
		<p>Untuk warga, silakan gunakan : username "warga" dan password "warga"</a></p>
    </form>
</div>
</body>
</html>