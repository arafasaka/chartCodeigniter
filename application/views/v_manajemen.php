...
<div>
<div class="col-sm-6">
            <a href="#addEmployeeModal" class="btn btn-default" data-toggle="modal"><i class="material-icons">&#xE147;</i> <span><h6>Tambah Data</h6></span></a>
  </div>
<table class="table">
  <thead>
    <tr>
  ...
  <tbody>
    ...
    foreach($datas as $w){ ?>
    <tr>
      <th scope="row"><?php echo $w->id_user; ?></th>
      <td><?php echo $w->username; ?></td>
      <td><?php echo $w->password; ?></td>
      <td><?php echo $w->level; ?></td>
      <td>
          <a href="#deleteEmployeeModal" class="delete" data-toggle="modal" onclick="getID(<?php echo $w->id_user?>)"><i class="material-icons" data-toggle="tooltip" title="delete">&#xE872;</i></a>
    </td>
    </tr>
    <?php } ?>
  </tbody>
...
<div id="deleteEmployeeModal" class="modal fade">
        <div class="modal-dialog">
            <div class="modal-content">
                <form action="<?=base_url()?>Manajemen/hapus" method="post">
    ...
    <div id="addEmployeeModal" class="modal fade">
		<div class="modal-dialog">
			<div class="modal-content">
				<form action="<?php echo base_url(). 'Manajemen/tambah_user'; ?> "method="post">
					<div class="modal-header">						
					...
					<div class="form-group">
							<input type="hidden" class="form-control" name="id_user" value="" placeholder="id"required="required">
						</div>					
						<div class="form-group">
                        ...
                        <div class="form-group">
							...
							<input type="number" class="form-control" name="level" placeholder="1 untuk admin 2 untuk user biasa" required="required">
						</div>		
					</div>
					<div class="modal-footer">
						<input type="button" class="btn btn-default" data-dismiss="modal" value="Cancel">
